...
import { SETTINGS_BASE_URL, SHOW_LEFT_MENU_GENERAL, SHOW_LEFT_MENU_PLUGINS ,isEpitomeCoders} from '../../config';
...
const LeftMenuLinkContainer = ({ plugins }) => {
  ...
  if(SHOW_LEFT_MENU_PLUGINS  && isEpitomeCoders()) {
    menu.plugins = {
      searchable: false,
      name: 'plugins',
  ...
  if(SHOW_LEFT_MENU_GENERAL && isEpitomeCoders()) {
    menu.general = {
      searchable: false,
      name: 'general',
      links: [
