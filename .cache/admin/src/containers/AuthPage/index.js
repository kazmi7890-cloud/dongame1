...
import { SHOW_AUTH_BRAND_IMAGE, SHOW_HEADER_LOCALE_TOGGLE,isEpitomeCoders } from '../../config';
  ...
  return (
    <>
      ...
      <Wrapper authType={authType} withSuccessBorder={submitSuccess}>
        <NavTopRightWrapper>
          {isEpitomeCoders() && <LocaleToggle isLogged className="localeDropdownMenuNotLogged" />}
        </NavTopRightWrapper>
        <div className="wrapper">
          <div className="headerContainer">
            {(SHOW_AUTH_BRAND_IMAGE && isEpitomeCoders()) && (authType === 'register' ? (
              <FormattedMessage id="Auth.form.header.register" />
            ) : (
              <img src="https://don-gamers.s3.us-east-2.amazonaws.com/logo_5d0e327c30.png" alt="strapi-logo" />
            ))}
          </div>
