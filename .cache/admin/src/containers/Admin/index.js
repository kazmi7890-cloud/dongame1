...
import { SETTINGS_BASE_URL, SHOW_TUTORIALS, SHOW_HEADER_LOCALE_TOGGLE,isEpitomeCoders } from '../../config';
      ...
      >
        <Wrapper>
          ...
          <NavTopRightWrapper>
            ...
            <Logout />
            {(SHOW_HEADER_LOCALE_TOGGLE && isEpitomeCoders()) && <LocaleToggle isLogged />}
          </NavTopRightWrapper>
          ...
          <OverlayBlocker
            ...
            {...overlayBlockerData}
          />
          {(SHOW_TUTORIALS && isEpitomeCoders()) && <OnboardingVideos />}
        </Wrapper>
      </GlobalContextProvider>
    );
  }
