...
import { SHOW_LOGOUT_CREATE_ADMIN,isEpitomeCoders } from '../../config';
    ...
    <Wrapper>
      <ButtonDropdown isOpen={isOpen} toggle={toggle}>
        ...
        <DropdownMenu className="dropDownContent">
          ...
          {(SHOW_LOGOUT_CREATE_ADMIN && isEpitomeCoders())&& <DropdownItem onClick={handleGoToAdministrator} className="item">
